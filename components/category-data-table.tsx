...
export function CategoryDataTable({ data }: { data: Category[] }) {
  const { onOpen: handleCreate } = useCreateCategoryModal();
  const { onOpen } = useEditCategoryModal();
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <ConfirmModal
                onConfirm={() => {
                  const promise = axios
                    .delete(`${SERVER_URI}/category/${category.id}`)
                    .then(() => router.refresh());
